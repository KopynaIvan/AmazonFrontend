import { cart, removeFromCart, updateCartQuantity, updateQuantity, updateDeliveryOption, saveToStorage} from "../../data/cart.js";
        ...
        <div class="cart-item-container js-cart-item-container-${matchingProduct.id}">
                ...
                <div class="cart-item-details-grid">
                    ...
                    <div class="product-quantity">
                        ...
                        <input class="quantity-input css-quantity-input select-input">
                        <span class="save-quantity-link link-primary save-link" data-update-id="${matchingProduct.id}">Save
                        </span>
